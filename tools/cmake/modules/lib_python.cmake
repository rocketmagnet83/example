if(WITH_LIB_PYTHON)
	...
	set(LIB_PYTHON_INC_PATH ${OUTPUT_PATH}/libs/python/include/python3.7m/)
	set(LIB_PYTHON_LIB_PATH ${OUTPUT_PATH}/libs/python/bin)
	...
	ExternalProject_Add(external_python
			...
			URL_MD5 ${PYTHON_HASH}
			CONFIGURE_COMMAND  cd ${CMAKE_BINARY_DIR}/python/src/external_python/ && ./configure --prefix=${OUTPUT_PATH}/libs/python
			...
			INSTALL_DIR ${OUTPUT_PATH}/libs/python
	)
